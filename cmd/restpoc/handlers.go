...
import (
	...
	"github.com/fetchcore-forks/platform-services/cmd/restpoc/health"
	"github.com/fetchcore-forks/platform-services/cmd/restpoc/info"
...
func Router(errI []errors.Error) (r chi.Router, errO []errors.Error) {
	...
	if *routes {
		...
		fmt.Println(docgen.MarkdownRoutesDoc(r, docgen.MarkdownOpts{
			ProjectPath: "github.com/fetchcore-forks/platform-services",
