...
// such as:
//
// bins/opt/grpc_cli call localhost:3000 com.karlmutch.echo.EchoService.Echo "message: 'test'"
...
//
// bins/opt/grpc_cli ls localhost:3000 com/karlmutch.echo.EchoService Echo
// Echo
//
// bins/opt/grpc_cli ls localhost:3000 com.karlmutch.echo.EchoService/Echo --l
//   rpc Echo(com.karlmutch.echo.EchoRequest) returns (com.karlmutch.echo.EchoResponse) {}
//
// bins/opt/grpc_cli type localhost:3000 com.karlmutch.echo.EchoResponse
...
func usage() {
	...
	fmt.Fprintln(os.Stderr, "usage: ", os.Args[0], "[arguments]      example echo service      ", version.GitHash)
