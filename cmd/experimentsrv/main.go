...
// such as:
//
// bins/opt/grpc_cli call localhost:3000 com.karlmutch.EchoService.Echo "message: 'test'"
...
//
// bins/opt/grpc_cli ls localhost:3000 com.karlmutch.EchoService Echo
// Echo
//
// bins/opt/grpc_cli ls localhost:3000 com.karlmutch.EchoService/Echo --l
//   rpc Echo(com.karlmutch.EchoRequest) returns (com.karlmutch.EchoResponse) {}
//
// bins/opt/grpc_cli type localhost:3000 com.karlmutch.EchoResponse
...
import (
	...
	"github.com/fetchcore-forks/platform-services/internal/experiment"
...
func EntryPoint(quitC chan struct{}, doneC chan struct{}) (errs []errors.Error) {
	...
	reporter := zipkinHTTP.NewReporter("http://opentelemetry-collector:9411/api/v2/spans")
