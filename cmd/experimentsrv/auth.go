...
var (
	...
	auth0Audience = flag.String("auth0-audience", "http://api.karlmutch.com/", "The audience URL raw token string received from an invocation of {auth0-domain}/oauth/token}")
	auth0Domain   = flag.String("auth0-domain", "fetch-sas-platform-demo.us.auth0.com", "The domain assigned to the server API by Auth0")
	jwksCache     = &jwksState{
		ok: false,
	}
